...
describe('routerViewport', function () {
  ...
  it('should work in a simple case', inject(function ($router) {
    compile('<router-viewport></router-viewport>');
  ...
  it('should work with multiple named viewports', inject(function ($router) {
    ...
    compile('port 1: <div router-viewport="one"></div> | ' +
            'port 2: <div router-viewport="two"></div>');
  ...
  it('should work with nested viewports', inject(function ($router) {
    put('childRouter', '<div>inner { <div router-viewport></div> }</div>');
    ...
    compile('<div>outer { <div router-viewport></div> }</div>');
  ...
  it('should work with recursive nested viewports', inject(function ($router) {
    ...
    put('router', '<div>recur { <div router-viewport></div> }</div>');
    $router.config([
      { path: '/recur', component: 'router' },
      { path: '/', component: 'one' }
    ]);

    compile('<div>root { <div router-viewport></div> }</div>');
    $router.navigate('/');
    $rootScope.$digest();
  ...
  it('should allow params in routerLink directive', inject(function ($router) {
    put('router', '<div>outer { <div router-viewport></div> }</div>');
    ...
    compile('<div router-viewport></div>');
...
describe('routerViewport animations', function () {
  ...
  beforeEach(function() {
    ...
    put('router', '<div router-viewport></div>');
