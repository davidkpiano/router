...
This is a pretty typical angular app, except the `router-viewport` directive.
`router-viewport` is like `ng-view`; it's a placeholder for part of your app loaded
